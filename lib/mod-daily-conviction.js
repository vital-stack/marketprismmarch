...
(function(){
  ...
  async function init(){
    try{
      ...
      // 2. COORDINATED ACTIVITY — from v_trade_cards (fetched separately)
      ...
      // 5. SAFE — Structurally supported (bottom)
      if(safeN){
      ...
      // Now fetch coordinated signals from v_trade_cards and inject
