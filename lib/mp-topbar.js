...
(function(){
  ...
  var TOPBAR_CSS = ''+
    '.topbar{position:sticky;top:0;z-index:50;background:rgba(255,255,255,0.92);backdrop-filter:blur(40px) saturate(1.2);border-bottom:1px solid var(--mp-border);padding:0 36px;height:56px;display:flex;align-items:center;justify-content:space-between;gap:16px;}'+
    '[data-theme="dark"] .topbar{background:rgba(11,17,32,0.88);backdrop-filter:blur(40px);}'+
    ...
    '.scholar-bar{display:flex;align-items:center;gap:10px;width:100%;position:relative;padding:9px 16px;border-radius:12px;border:1px solid rgba(0,0,0,0.08);background:#FAFBFC;transition:all .3s cubic-bezier(0.16,1,0.3,1);cursor:text;}'+
    '.scholar-bar:hover{border-color:rgba(0,0,0,0.12);}'+
    '.scholar-bar:focus-within{border-color:rgba(0,174,255,0.3);box-shadow:0 0 0 3px rgba(0,174,255,0.08);}'+
    '[data-theme="dark"] .scholar-bar{border-color:rgba(232,232,227,0.12);background:linear-gradient(135deg,rgba(232,232,227,0.03),rgba(232,232,227,0.01));}'+
    '[data-theme="dark"] .scholar-bar:hover{border-color:rgba(232,232,227,0.18);background:linear-gradient(135deg,rgba(232,232,227,0.05),rgba(232,232,227,0.02));}'+
    '[data-theme="dark"] .scholar-bar:focus-within{border-color:rgba(232,232,227,0.25);background:linear-gradient(135deg,rgba(232,232,227,0.06),rgba(232,232,227,0.03));}'+
  ...
  MP.initScholarBar = function(opts){
    ...
    var EXCL = window.MP_EXCLUDED_TICKERS || '';
