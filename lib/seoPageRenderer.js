...
function getPageConfig(ticker, pageType, narr, data) {
  ...
  if (pageType === 'why-down') {
    return {
      seoTitle: `Why Is ${ticker} Stock Down Today? | Market Prism Analysis`,
      metaDesc: `${ticker} stock analysis: ${narr.summary.substring(0, 120)} Forensic narrative intelligence from Market Prism.`,
  ...
  if (pageType === 'overvalued') {
    return {
      seoTitle: `Is ${ticker} Overvalued? Fair Value Analysis | Market Prism`,
      metaDesc: `Is ${ticker} overvalued? ${narr.isOvervalued.substring(0, 100)} Forensic valuation analysis from Market Prism.`,
  ...
  // should-buy
  return {
    seoTitle: `Should I Buy ${ticker} Stock? Analysis & Signals | Market Prism`,
    metaDesc: `Should you buy ${ticker}? ${narr.summary.substring(0, 100)} Forensic signal intelligence from Market Prism.`,
