...
function buildCard(r, idx){
  ...
  return '<div class="tcv2-card" data-ticker="'+MP.esc(r.ticker)+'" style="animation-delay:'+delay+'s;">'
    ...
    + '<div class="tcv2-body">'
      ...
      + '</div>'
      // Row 3: Action (the "what to do")
      + '<div class="tcv2-action">'+MP.esc(action)+'</div>'
      // Row 4: Confidence bar
      + '<div class="tcv2-conf-row">'
        + '<span class="tcv2-conf-label">Confidence</span>'
        + '<div class="tcv2-conf-bar"><div class="tcv2-conf-fill" style="width:'+confPct+'%;"></div></div>'
        + '<span class="tcv2-conf-pct">'+confPct+'%</span>'
      + '</div>'
      // Row 5: Meta line
      + '<div class="tcv2-meta">'
